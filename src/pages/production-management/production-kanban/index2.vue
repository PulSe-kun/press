    ...
    <a-row :gutter="[15, 15]">
      <a-col :xs="24" :sm="24" :md="24" :lg="17">
        <div class="item-model">
          ...
          <div ref="fault" v-if="For15Days.length > 0"></div>
...
export default {
  ...
  methods: {
    ...
    initChart1() {
      var echartsPress = this.$echarts.init(this.$refs.press)
      const arr3 = []
      const arr4 = []
    ...
    initChart2() {
      var echartsFault = this.$echarts.init(this.$refs.fault)
      const arr = []
      const arr2 = []
